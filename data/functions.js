//NEMA POTREBA OD OVIE FUNCKII ZOSTO SE KJE SE ZEMA OD APITO //
//const functions = async () => {
  ...
  //  Gets the number of articles for every author
  ...
  //  Gets the number of comments for every article
  ...
  // articles.forEach(obj => changeDate(obj));
  // comments.forEach(obj => changeDate(obj));
...
//  Sorting function, takes three arguments 
    //  1. Array of objects to sort, 
    //  2. What key of the object to sort by (String), 
    //  3. Ascending (asc), Descending(desc), a-z or z-a(String)
...
function paginationNvg(TOTAL_PAGES, currentPage) {
  if (TOTAL_PAGES > 1) {
      let buttonDisable = [{
